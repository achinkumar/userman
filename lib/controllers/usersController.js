...
exports.create = function (req, res, next) {
    ...
    userDao.createUser(newUser, function (err, createdUser) {
        ...
        var options = {
            "senderName": "PayKart",
            "senderEmail": "saurabh@prokriya.com",
            "receiverName": newUser.name,
            "receiverEmail": newUser.email,
            "subject": "Welcome to PayKart",
            "textBody": "Welcome to PayKart",
            "htmlBody": "<b>Welcome to PayKart</b>"
        }
        mailer.sendNotification(options, null);// callback null to avoid waiting
